...
function preload() {
	...
	game.load.image('enemyBullet', './static/img/enemy-bullet.png');
	game.load.spritesheet('invader', './static/img/invader32x32x4.png', 32, 32);
	...
	game.load.image('background', './static/img/background2.png');
